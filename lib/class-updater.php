...
class Updater {
    ...
    public function __construct() {
        ...
        if ( defined( 'WP_KIWWWILAB_DEV_MODE' ) ) {
        ...
        $this->version       = '1.1';
        $this->cache_key     = 'kiwwwilab_updater';
    ...
    public function request(){
        ...
        if( false === $remote || ! $this->cache_allowed ) {
            ...
            $remote = wp_remote_get( 'https://kiwwwilab.com/kiwwwilab-extend-updater.json', [
                    'timeout' => 10,
                    'headers' => [
